...
cont_pick = max(gamepad_button_check(device, ds_map_find_value(global.ckeys,"pick")), keyboard_check(ds_map_find_value(global.keys,"potion")));
...
cont_ml = gamepad_button_check(device, gp_shoulderrb);
cont_mr = gamepad_button_check(device, gp_shoulderlb);
cont_mlp = gamepad_button_check_pressed(device, gp_shoulderrb);
cont_mrp = gamepad_button_check_pressed(device, gp_shoulderlb);
cont_mlr = gamepad_button_check_released(device, gp_shoulderrb);
cont_mrr = gamepad_button_check_released(device, gp_shoulderlb);
key_sskill = gamepad_button_check_pressed(device, gp_shoulderl);
key_tskill = gamepad_button_check_pressed(device, gp_shoulderr);
