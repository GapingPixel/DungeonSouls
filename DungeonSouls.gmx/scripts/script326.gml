...
if ( instance_exists(obj_Char_Select_Soul) ) then exit;
    ...
    else if (keyboard_check_pressed(vk_escape) || (joystick_detected && joystick_button_pressed[0,2])) && passive == false
    {
        Play_Sound(snd_choose,1,.5,0,5000,true,false);
        instance_create(x,y,obj_FadeOut);
        room_goto_previous();
    ...
    } else if mouse_check_button_pressed(mb_left) && passive == false
    {
