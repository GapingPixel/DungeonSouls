...
{
    if (saveFileUpgrade("dungeonsouls.ds"))
    {
        logger_write("UPDATED STATS TO NEWEST VERSION OF THE GAME");
        show_message("Dungeon Souls has detected that the save file belonged to a previous version and updated it!")
    }
    else if (!checkStatsIntegrity("dungeonsouls.ds",51))
    {
